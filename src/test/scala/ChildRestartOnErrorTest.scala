import akkademy.fault.ChildRestartOnErrorApp.ParentActor
import akkademy.fault.ChildRestartOnErrorApp.ParentActor.TriggerChild
...
class ChildRestartOnErrorTest extends ScalaTestWithActorTestKit with AnyFunSuiteLike with Matchers {
